...
posting_all_data_report = terra2portal_transfer.post_all_successful_runs(full_terra_data_table=terra_to_portal_post_datatable, igvf_api=igvf_api_sandbox, igvf_utils_api=iu_conn_sandbox, upload_file=False)
