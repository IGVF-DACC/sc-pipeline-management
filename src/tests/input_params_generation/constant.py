...
TEST_SEQFILES_METADATA = [portal_parsing.SeqFileMetadata(file_accession='IGVFFI6948UZJO', file_set='/measurement-sets/IGVFDS9139TBCB/', illumina_read_type='R1', sequencing_run=1, lane=4, flowcell_id='223JHYLT3', file_url='https://api.data.igvf.org/sequence-files/IGVFFI6948UZJO/@@download/IGVFFI6948UZJO.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI2433YUEJ/@@download/IGVFFI2433YUEJ.yaml.gz'], read_names=['Read 1'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI7951DAQB', file_set='/measurement-sets/IGVFDS9139TBCB/', illumina_read_type='R2', sequencing_run=1, lane=4, flowcell_id='223JHYLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI7951DAQB/@@download/IGVFFI7951DAQB.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI2433YUEJ/@@download/IGVFFI2433YUEJ.yaml.gz'], read_names=['Read 2'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI0391NHGA', file_set='/measurement-sets/IGVFDS1013HCXI/', illumina_read_type='R2', sequencing_run=1, lane=8, flowcell_id='223JKJLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI0391NHGA/@@download/IGVFFI0391NHGA.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI1365BOUI/@@download/IGVFFI1365BOUI.yaml.gz'], read_names=['Barcode index'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI4665EVGC', file_set='/measurement-sets/IGVFDS1013HCXI/', illumina_read_type='R1', sequencing_run=1, lane=8, flowcell_id='223JKJLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI4665EVGC/@@download/IGVFFI4665EVGC.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI1365BOUI/@@download/IGVFFI1365BOUI.yaml.gz'], read_names=['Read 1'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI4986VMDU', file_set='/measurement-sets/IGVFDS1013HCXI/', illumina_read_type='R3', sequencing_run=1, lane=8, flowcell_id='223JKJLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI4986VMDU/@@download/IGVFFI4986VMDU.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI1365BOUI/@@download/IGVFFI1365BOUI.yaml.gz'], read_names=['Read 2'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI4633WXZI', file_set='/measurement-sets/IGVFDS5272EQRG/', illumina_read_type='R1', sequencing_run=2, lane=1, flowcell_id='AAC2JNKHV',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI4633WXZI/@@download/IGVFFI4633WXZI.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI2264BQQD/@@download/IGVFFI2264BQQD.yaml.gz'], read_names=['Read 1'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI9320MADV', file_set='/measurement-sets/IGVFDS5272EQRG/', illumina_read_type='R2', sequencing_run=2, lane=1, flowcell_id='AAC2JNKHV',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI9320MADV/@@download/IGVFFI9320MADV.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI2264BQQD/@@download/IGVFFI2264BQQD.yaml.gz'], read_names=['Read 2'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI0777CMJH', file_set='/measurement-sets/IGVFDS6617HQDI/', illumina_read_type='R1', sequencing_run=7395, lane=None, flowcell_id='22KFLYLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI0777CMJH/@@download/IGVFFI0777CMJH.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI5825ATCM/@@download/IGVFFI5825ATCM.yaml.gz'], read_names=['Read 1'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI7330UNCB', file_set='/measurement-sets/IGVFDS6617HQDI/', illumina_read_type='R2', sequencing_run=7395, lane=None, flowcell_id='22KFLYLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI7330UNCB/@@download/IGVFFI7330UNCB.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI5825ATCM/@@download/IGVFFI5825ATCM.yaml.gz'], read_names=['Read 2', 'Barcode index'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI1918YZDJ', file_set='/measurement-sets/IGVFDS8487QXIK/', illumina_read_type='R1', sequencing_run=7383, lane=None, flowcell_id='22KFLYLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI1918YZDJ/@@download/IGVFFI1918YZDJ.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI8012OCZQ/@@download/IGVFFI8012OCZQ.yaml.gz'], read_names=['Read 1'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI4773YQEF', file_set='/measurement-sets/IGVFDS8487QXIK/', illumina_read_type='R2', sequencing_run=7383, lane=None, flowcell_id='22KFLYLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI4773YQEF/@@download/IGVFFI4773YQEF.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI8012OCZQ/@@download/IGVFFI8012OCZQ.yaml.gz'], read_names=['Read 2', 'Barcode index'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI4117HDFW', file_set='/measurement-sets/IGVFDS8023XWXR/', illumina_read_type='R1', sequencing_run=358, lane=None, flowcell_id=None,
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI4117HDFW/@@download/IGVFFI4117HDFW.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI8568RJIP/@@download/IGVFFI8568RJIP.yaml.gz'], read_names=['Read 1'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI9675ROSO', file_set='/measurement-sets/IGVFDS8023XWXR/', illumina_read_type='R2', sequencing_run=358, lane=None, flowcell_id=None,
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI9675ROSO/@@download/IGVFFI9675ROSO.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI8568RJIP/@@download/IGVFFI8568RJIP.yaml.gz'], read_names=['Read 2'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI8200NDMC', file_set='/measurement-sets/IGVFDS1474QEZX/', illumina_read_type='R2', sequencing_run=1, lane=7, flowcell_id='22Y7YHLT3',
                                                         file_url='https://api.data.igvf.org/sequence-files/IGVFFI8200NDMC/@@download/IGVFFI8200NDMC.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI1382HZDV/@@download/IGVFFI1382HZDV.yaml.gz'], read_names=['Read 2'], status='released'),
                          portal_parsing.SeqFileMetadata(file_accession='IGVFFI9019AATO', file_set='/measurement-sets/IGVFDS1474QEZX/', illumina_read_type='R1', sequencing_run=1, lane=7, flowcell_id='22Y7YHLT3', file_url='https://api.data.igvf.org/sequence-files/IGVFFI9019AATO/@@download/IGVFFI9019AATO.fastq.gz', seqspec_urls=['https://api.data.igvf.org/configuration-files/IGVFFI1382HZDV/@@download/IGVFFI1382HZDV.yaml.gz'], read_names=['Read 1'], status='released')]
