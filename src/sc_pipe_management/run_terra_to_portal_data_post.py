...
import sc_pipe_management.terra_to_portal_posting as terra2portal_transfer
import argparse
import logging
...
def main():
    ...
    if args.post_endpoint == 'sandbox':
        igvf_utils_mode = 'sandbox'
    elif args.post_endpoint == 'production':
        igvf_utils_mode = 'prod'
    igvf_utils_api = api_tools.get_igvf_utils_connection(igvf_api_keys=igvf_api_keys,
                                                         igvf_utils_mode=igvf_utils_mode,
